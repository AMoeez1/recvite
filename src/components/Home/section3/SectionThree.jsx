    ...
    <section className="section-container">
      ...
      <div className="content">
        <div className="text-content-home">
          <h2 className="section-title">We are a client-needs driven company</h2>
          <p className="section-description">
            Our job is to make sure that you have the peace of mind when hiring an
            ...
            large, making sure we provide the best recruiting consulting services
            with the best.
          </p>
        </div>
