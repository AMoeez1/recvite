  ...
  return (
    ...
    <Header />
      ...
      <ServiceRight
        ...
        para="It takes a second to make an impression that lasts, and with the right tools, your company might just be able to impress the right people. Whether it’s with an attractive logo or a pop of color, or anything else you have in mind; our graphic designing services will cater to all your needs. Our designers will add the little spark your company needs to catch people’s eyes. In order to make sure your company’s ideas and services are projected clearly to customers in such a way that makes them stick around, our graphic designers will work closely with you to make your vision comes to life."
        subtitle=""
        image={Vector}
      />
      <ServiceLeft
        ...
        para="Building a strong SEO foundation is the first step to making sure your company is meeting its maximum online potential. It helps you target the right audience, build a solid online presence, and manage your social media traffic. Our SEO price packages and digital marketing packages USA just might be the thing for your company to break into the online market."
        subtitle=""
        image={Google}
      />
